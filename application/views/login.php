  ...
  <div class="login-box-body">
    ...
    <form action="<?php echo site_url('login/auth'); ?>" method="post">
      ...
      <div class="row">
        ...
        <a href="<?php echo site_url('registrasi'); ?>"><button type="button" class="btn btn-primary btn-block btn-flat">Registrasi</button></a>
      </div>
    </form>
  </div>
  <!-- /.login-box-body -->
